...
class GBResidency extends TaxResidency {
  ...
  _getShiftedTaxBrackets(year, type, region = null) {
    ...
    if (region && brackets.some(b => b.Region !== undefined && b.Region !== null && b.Region !== '')) {
  ...
  calculateEmploymentTax(grossIncome, specialRegimeStatus, isUKSource, year, region = null) {
  ...
  calculateDividendTax(
    ...
    if (region && dividendBands.some(b => b.Region !== undefined && b.Region !== null && b.Region !== '')) {
