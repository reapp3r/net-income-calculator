...
describe('NHR Status', () => {
  ...
  test('returns true for active NHR', () => {
    expect(isNHRActive('2023-06-15', 2025, referenceData.specialRegimes)).toBe(true); // Year 3 of 10
  });

  test('returns false for expired NHR', () => {
    expect(isNHRActive('2015-01-01', 2026, referenceData.specialRegimes)).toBe(false); // Year 11 of 10
  });

  test('getNHRStatus returns correct status', () => {
    const status = getNHRStatus('2023-06-15', 2025, referenceData.specialRegimes);
  ...
  test('getNHRStatus for expired', () => {
    const status = getNHRStatus('2015-01-01', 2026, referenceData.specialRegimes);
...
describe('Dividend Tax', () => {
  ...
  test('flat 28% rate', () => {
    const result = residency.calculateDividendTax(10000, { active: false }, 'PT', false, 2025);
  ...
  test('NHR exempt', () => {
    const result = residency.calculateDividendTax(10000, { active: true }, 'UK', false, 2025);
